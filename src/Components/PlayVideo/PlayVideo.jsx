...
const PlayVideo = () => {
    ...
    const [cahnnelData,setChannelData]=useState(null)
  ...
  return (
    <div className='play-video'>
        ...
        <div className="publisher">
            <img src={cahnnelData?cahnnelData.snippet.thumbnails.default.url:""} alt="" />
            <div>
                <p> {apiData?apiData.snippet.channelTitle:" "}</p>
                <span>{cahnnelData?value_converter(cahnnelData.statistics.subscriberCount):""} Subscribers</span>
            </div>
